/*
 * Daniel Walther
 * creation date (dd.mm.yyyy): 03.12.2023
 * purpose: Print out the filenames of all files contained in a chosen folder. The use of this is to note all single slices with "ignore" or "lens" labels on them for creation of dataset08.4.
 */


macro_filename = "print_filenames_in_chosen_folder.ijm"
print("-----------------------------------------------------------");
...
print("Now printing all filenames of the files contained in the chosen folder:");
